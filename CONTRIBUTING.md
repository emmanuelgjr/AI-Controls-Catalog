...
PRs are welcome â€” especially from auditors, AI governance leads, CISOs,
...
1. **Propose a new control.** Open an issue using the *Propose a control*
   ...
   `src/content.config.ts (schemas in src/content/schemas.ts)`.
...
- All schema fields populated â€” no nulls or TODOs.
- Test of Design has â‰¥ 3 procedures, â‰¥ 1 inquiries, â‰¥ 1 inspections.
- Test of Operating Effectiveness has â‰¥ 3 procedures with sample-size
  guidance for low / moderate / high risk populations.
- â‰¥ 3 framework mappings with valid clause / section references.
- Evidence requirements include format and retention guidance.
- â‰¥ 2 authoritative references with working URLs.
...
field. Substantive contributors (â‰¥ 3 merged content PRs) are listed on
the About page.
